...
#define LCD_SCLK_Clr() GPIO_ResetBits(GPIOA,GPIO_Pin_15)//SCL=SCLK
#define LCD_SCLK_Set() GPIO_SetBits(GPIOA,GPIO_Pin_15)

#define LCD_MOSI_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_3)//SDA=MOSI
#define LCD_MOSI_Set() GPIO_SetBits(GPIOB,GPIO_Pin_3)
